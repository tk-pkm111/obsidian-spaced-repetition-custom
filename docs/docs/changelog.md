...
#### [1.14.0-custom.11](https://github.com/tk-pkm111/obsidian-spaced-repetition-custom/compare/1.14.0-custom.10...1.14.0-custom.11)

> 7 June 2026

- feat: replace the note review queue's fixed reschedule buttons (1/3/7 days) with proper spaced-repetition response buttons (短く/スキップ/長く)
- fix: reschedule via the right sidebar now runs the OSR algorithm so intervals grow with ease instead of being reset to a fixed value
- chore: add type annotation to the editor context menu callback

#### [1.14.0-custom.10](https://github.com/tk-pkm111/obsidian-spaced-repetition-custom/compare/1.14.0-custom.9...1.14.0-custom.10)

> 15 March 2026

- fix: add a legacy command compatibility layer so old Note Toolbar / hotkey command IDs keep working
- fix: migrate `hotkeys.json` and Note Toolbar command references from `obsidian-spaced-repetition:*` to `obsidian-spaced-repetition-custom:*`
- test: add coverage for legacy command alias registration and config migration
